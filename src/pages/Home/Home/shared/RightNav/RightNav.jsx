    ...
    <div>
      ...
      <div className="mt-3">
        ...
        <ListGroup className=" px-2">
          <ListGroup.Item>
            <FaFacebook className=" me-2 text-info" />
            Facebook
          </ListGroup.Item>
          <ListGroup.Item>
      ...
      <div className="bg-light text-center py-4 my-4">
        ...
        <div className="text-position">
          <h5 className="mb-3">
            Create an amazing newsPaper Sites With MD Rayhan Shorker
            <small className="text-info">(Web Developer).</small>
          </h5>
          <p>
        ...
        <Button className="btn-position" variant="danger">
          Learn More
        </Button>
      </div>
    </div>
